  ...
  return (
    <div className="col-span-full bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        <h2 className="font-semibold text-slate-800">Employees salary details</h2>
      </header>
      <div className="p-3">
          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs font-semibold uppercase text-slate-400 bg-slate-50">
              <tr>
                ...
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left">Provided pay slips</div>
                </th>
                <th className="p-2 whitespace-nowrap">
                ...
                customers.map(customer => {
                  return (
                    <tr key={customer._id}>
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-10 h-10 shrink-0 mr-2 sm:mr-3">
                            <img className="rounded-full" src="https://www.seekpng.com/png/detail/41-410093_circled-user-icon-user-profile-icon-png.png" width="40" height="40" alt={customer.name} />
                          </div>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <Link to="/paySlip" type='button' state={{id: customer._id}} className='bg-blue-500 text-center text-white rounded-2xl w-20 h-6'>
                          Click
                        </Link>
                      </td>
